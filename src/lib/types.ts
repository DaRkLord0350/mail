...
export interface AttachmentDTO { name: string; mimeType: "application/pdf"; sizeBytes: number; }
export interface TemplateDTO { id: string; name: string; subject: string; body: string; attachment: AttachmentDTO | null; createdAt: string; updatedAt: string; }
...
export interface CampaignDTO { id: string; name: string; status: CampaignStatus; templateId: string | null; subjectTemplate: string; bodyTemplate: string; attachment: AttachmentDTO | null; dailyLimit: number; scheduledAt: string | null; timezone: string; lastError: string | null; createdAt: string; updatedAt: string; startedAt: string | null; pausedAt: string | null; completedAt: string | null; recipientCount: number; counts: Record<DeliveryStatus, number>; sendingHaltedReason: string | null; }
